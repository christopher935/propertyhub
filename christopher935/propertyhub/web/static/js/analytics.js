...
class PropertyHubAnalytics {
    ...
    init() {
        Logger.log('📊 PropertyHub Analytics initializing...');
        
        // Check if tracking is allowed
        if (!this.isTrackingAllowed()) {
            Logger.log('🚫 Analytics tracking disabled by user preference');
            return;
        }
        ...
        Logger.log('✅ PropertyHub Analytics initialized');
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (consent === 'granted') {
        ...
        Logger.log('Analytics consent required');
    }
});
