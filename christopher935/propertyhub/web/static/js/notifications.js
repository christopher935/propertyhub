...
class PropertyHubNotifications {
    ...
    async init() {
        Logger.log('🔔 PropertyHub Notifications initializing...');
        ...
        Logger.log('✅ PropertyHub Notifications ready');
    }

    // WebSocket Connection Management
    async setupWebSocketConnection() {
        if (!window.PropertyHubAuth || !window.PropertyHubAuth.isAuthenticated()) {
            Logger.log('⏳ Waiting for authentication before connecting notifications...');
        ...
        try {
            ...
            this.websocket.onopen = () => {
                Logger.log('🔗 Notifications WebSocket connected');
                this.retryCount = 0;
            ...
            Logger.log('🔌 Notifications WebSocket closed');
    ...
    scheduleReconnect() {
        if (this.retryCount < this.maxRetries) {
            ...
            setTimeout(() => {
                this.retryCount++;
                Logger.log(`🔄 Reconnecting notifications (attempt ${this.retryCount}/${this.maxRetries})`);
    ...
    handleIncomingNotification(message) {
        switch (message.type) {
            ...
            case 'preferences_updated':
                ...
                break;
            default:
                Logger.log('Unknown notification message type:', message.type);
        }
    }
    ...
    showPreferences() {
        ...
        Logger.log('Showing notification preferences');
    }
