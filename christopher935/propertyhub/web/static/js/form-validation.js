...
class PropertyHubFormValidation {
    ...
    async init() {
        Logger.log('✅ PropertyHub Form Validation initializing...');
        ...
        Logger.log('✅ PropertyHub Form Validation ready');
    }
    ...
    setupFormValidation(form) {
        ...
        Logger.log(`📝 Form validation setup for: ${formId}`);
    }
    ...
    async executeValidationRule(rule, value) {
        ...
        if (!validator) {
            Logger.warn(`Unknown validation rule: ${rule.type}`);
            return true;
        }
        ...
        document.addEventListener('submit', (e) => {
            ...
            if (form.dataset.validate === 'true' || form.classList.contains('validate-form')) {
                ...
                if (formState && !formState.isValid) {
                    e.preventDefault();
                    Logger.log('Form submission prevented due to validation errors');
                }
            }
        });
